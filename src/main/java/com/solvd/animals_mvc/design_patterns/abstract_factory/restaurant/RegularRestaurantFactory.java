...
import com.solvd.animals_mvc.design_patterns.abstract_factory.burger.CheeseIBurger;
import com.solvd.animals_mvc.design_patterns.abstract_factory.pasta.IPasta;
import com.solvd.animals_mvc.design_patterns.abstract_factory.pasta.SpaghettiIPasta;

public class RegularRestaurantFactory extends RestaurantFactory {
    @Override
    public IBurger createBurger() {
        return new CheeseIBurger();
    }

    @Override
    public IPasta createPasta() {
        return new SpaghettiIPasta();
    }
}
